...
print(c1,c2)
# c2 = 1
# c1 = (u_b-y_0[-1]-c2*y_2[-1])/y_1[-1]

print('\n',c1,c2)
print([2*xi(i)**2+xi(i) for i in range(n+1)])
print([u_x(y_0[i], y_1[i], y_2[i]) for i in range(n)])
